...
export const GEN1_POKEMON: PokemonEntry[] = [
  ...
  { id: 29, name: 'Nidoran-F' }, { id: 30, name: 'Nidorina' }, { id: 31, name: 'Nidoqueen' },
  { id: 32, name: 'Nidoran-M' }, { id: 33, name: 'Nidorino' }, { id: 34, name: 'Nidoking' },
  ...
  { id: 95, name: 'Onix' }, { id: 96, name: 'Drowzee' }, { id: 97, name: 'Hypno' },
  ...
  { id: 113, name: 'Chansey' }, { id: 114, name: 'Tangela' },
  ...
  { id: 122, name: 'Mr. Mime' }, { id: 123, name: 'Scyther' },
  ...
  { id: 136, name: 'Flareon' }, { id: 137, name: 'Porygon' },
...
export function getRandomPokemon(): PokemonEntry {
  return GEN1_POKEMON[Math.floor(Math.random() * GEN1_POKEMON.length)];
}
